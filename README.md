...
7. In order to view the visulas generated (.qzv) files you will have to copy them on to your desktop and then drag and drop them onto QIIME2 View (https://view.qiime2.org). You could aslo transfer the .qzv files from your terminal to your desktop using Cyberduck by simply dragging and dropping.
